...
class _PopupProdutosState extends State<PopupProdutos> {
  ...
  bool _tentouSalvar =
      false; //usada para gerar as mensagens de erro se tentar salvar com algo em branco
  ...
  void initState() {
    ...
    String precoInicial =
        widget.produto.preco?.toStringAsFixed(2).replaceAll('.', ',') ?? '0,00';
    ...
    String dataFormatada = DateFormat(
      "dd/MM/yyyy 'as:' HH:mm",
    ).format(widget.produto.dataEdit);
      ...
      builder: (BuildContext contextDialog) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () =>
                  Navigator.pop(contextDialog), // Fecha apenas o aviso
              child: Text(
                "Cancelar",
                style: GoogleFonts.poppins(
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                try {
                  // Desativa o produto no firebase (Soft Delete)
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _construirCampoTexto("Marca", _marcaController),
                  ),
